        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <button class="btn btn-default" value="" type="submit">Add the code</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $publicQuantity == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="publicQuantity" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $publicDateAdded == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="publicDateAdded" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $multiVendor == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="multiVendor" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $outOfStock == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="outOfStock" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $hideBuyButtonsOfOutOfStock == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="hideBuyButtonsOfOutOfStock" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $refreshAfterAddToCart == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="refreshAfterAddToCart" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $moreInfoBtn == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="moreInfoBtn" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $showBrands == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="showBrands" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $showInSlider == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="showInSlider" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= isset($cookieLawInfo['cookieInfo']['visibility']) && $cookieLawInfo['cookieInfo']['visibility'] == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="visibility" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <hr>
                    ...
                    <button class="btn btn-default" name="setCookieLaw" value="" type="submit">Save</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <label style="display:inline-flex;align-items:center;gap:8px;margin-bottom:10px;">
                        <input <?= $virtualProducts == 1 ? 'checked' : '' ?> class="admin-toggle" data-for-field="virtualProducts" type="checkbox">
                        <span>Enable</span>
                    </label>
                    <button class="btn btn-default" value="" type="submit">Save</button>
                </form>
