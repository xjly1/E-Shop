                ...
                <?php foreach ($cartItems['array'] as $item) { ?>
                    ...
                    <div class="flex flex-col gap-3 rounded-2xl bg-slate-50 p-3 ring-1 ring-inset ring-slate-200 md:flex-row md:items-center md:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1 text-xs text-slate-600">
                                    <?= $item['price'] . CURRENCY ?> · <?= lang('total') ?>:
                                    <span class="item-total"><?= $item['sum_price'] . CURRENCY ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <a
                                class="cart-plus inline-flex items-center justify-center rounded-xl bg-white px-3 py-2 text-sm font-semibold text-slate-900 ring-1 ring-inset ring-slate-200 hover:bg-slate-50 <?= $item['quantity'] <= $item['num_added'] ? 'pointer-events-none opacity-50' : '' ?>"
                                data-id="<?= $item['id'] ?>"
                            ...
                            <a
                                class="cart-minus inline-flex items-center justify-center rounded-xl bg-white px-3 py-2 text-sm font-semibold text-slate-900 ring-1 ring-inset ring-slate-200 hover:bg-slate-50"
                                data-id="<?= $item['id'] ?>"
                                href="javascript:void(0);"
                            >
                            ...
                            <a
                                class="cart-delete inline-flex items-center justify-center rounded-xl bg-rose-600 px-3 py-2 text-sm font-semibold text-white hover:bg-rose-700"
                                data-id="<?= $item['id'] ?>"
                                href="javascript:void(0);"
                            >
