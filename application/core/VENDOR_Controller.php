...
class VENDOR_Controller extends MX_Controller
{
    ...
    protected function loginCheck()
    {
        ...
        } elseif (isset($_SESSION['logged_vendor']) && in_array($urlString, $authPages)) {
    ...
    private function setVendorInfo()
    {
        ...
        if (isset($_SESSION['logged_vendor'])) {
            ...
            $this->vendor_id = isset($array['id']) ? $array['id'] : null;
            $this->vendor_name = isset($array['name']) ? $array['name'] : '';
            $this->vendor_url = isset($array['url']) ? $array['url'] : '';
        }
    }
